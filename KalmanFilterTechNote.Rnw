...
\citet{wickham2009} for R. The code used for the Kalman filter relies
on the Jacobian function\index{function!Jacobian} in the R \index{R language!package!numDeriv}package
``numDeriv'' \index{Jacobian!numerical evaluation}version 2016.8-1;
cf.~\citet{numDeriv}.
