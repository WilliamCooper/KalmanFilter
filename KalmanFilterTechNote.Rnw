...
\textsf{\textsc{\textcolor{blue}{Workflow Document:}}}  & WorkflowKalmanFilter.pdf\tabularnewline
\textsf{\textsc{\textcolor{blue}{Git:}}}  & \index{GitHub repository}https://github.com/WilliamCooper/KalmanFilter.git\tabularnewline
\end{tabular}
